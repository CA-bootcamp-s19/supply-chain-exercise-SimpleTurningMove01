...
/* Create a modifer that checks if the msg.sender is the owner of the contract */
  ...
  modifier verifyCaller (address _address) { require (msg.sender == _address, "We are unable to service your request at this time "); _;}
  ...
  modifier forSale(uint _sku) {
    require(items[_sku].seller != address(0), "Item does not exist in current inventory");
  ...
  function buyItem(uint sku)
    public payable forSale(sku) paidEnough(msg.value) checkValue(sku) {
      // Pay the seller /transfer the money
